...
public class Op_DIV implements IOperatorExecution {
	...
	/* (non-Javadoc)
	 * @see org.levin.ikexpression.op.IOperatorExecution#execute(org.levin.ikexpression.ExpressionToken[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.levin.ikexpression.op.IOperatorExecution#verify(int, org.levin.ikexpression.ExpressionToken[])
	 */
