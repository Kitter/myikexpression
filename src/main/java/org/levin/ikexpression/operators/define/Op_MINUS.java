 ...
 * 2008-09-26
 */
public class Op_MINUS implements OperatorExecutor {

	public static final Operator THIS_OPERATOR = Operator.MINUS;
	/* (non-Javadoc)
	 * @see org.levin.ikexpression.op.define.IOperatorExectution#execute(org.levin.ikexpression.ExpressionToken[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.levin.ikexpression.op.define.IOperatorExectution#verify(int, org.levin.ikexpression.ExpressionToken[])
	 */
